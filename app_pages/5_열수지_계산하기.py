...
st.caption("교과서 자료(통합과학2_22개정 미래엔 82p)의 지구 열수지 평형 그림을 보고 두 가지 문제를 풀어봅시다.")
...
st.markdown(
    "<p style='font-size:17px;'>위 그림을 다시 참고하면서, 대기 중 CO₂가 늘어났을 때 각 에너지양이 "
    "<b>어떻게 변할지</b> 골라보세요.</p>",
...
if st.button("정답 확인", key="check2"):
    if "선택해주세요" in (step1, step2, step3, step4):
        ...
        st.info(
            "💡 **정리하면:** 대기 중 CO₂ 농도 증가 → 대기가 흡수하는 에너지양 **증가**(132보다) → "
