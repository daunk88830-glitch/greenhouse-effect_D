...
home = st.Page("app_pages/0_홈.py", title="홈", icon="🏠", default=True)

p1 = st.Page("app_pages/1_개념_이해.py", title="개념 이해", icon="📖")
p2 = st.Page("app_pages/2_시뮬레이션.py", title="시뮬레이션 체험", icon="🎚")
p3 = st.Page("app_pages/3_데이터_비교.py", title="데이터 비교", icon="📊")
